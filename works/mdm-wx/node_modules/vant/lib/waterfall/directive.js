...
function doBindEvent() {
  ...
  this.scrollEventTarget = _scroll.default.getScrollEventTarget(this.el);
...
function handleScrollEvent() {
  ...
  var targetScrollTop = _scroll.default.getScrollTop(scrollEventTarget);

  var targetVisibleHeight = _scroll.default.getVisibleHeight(scrollEventTarget); // 滚动元素可视区域下边沿到滚动元素元素最顶上 距离
  ...
  if (element === scrollEventTarget) {
    ...
    var elementBottom = _scroll.default.getElementTop(element) - _scroll.default.getElementTop(scrollEventTarget) + _scroll.default.getVisibleHeight(element);
  ...
  if (element === scrollEventTarget) {
    ...
    var elementTop = _scroll.default.getElementTop(element) - _scroll.default.getElementTop(scrollEventTarget);
