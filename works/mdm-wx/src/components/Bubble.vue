...
export default {
    ...
    created() {
        ...
        this.minTailRadius = 6 * this.ratio
        this.initArrowRadius = 9 * this.ratio
        this.minArrowRadius = 6 * this.ratio
        this.arrowWidth = 2 * this.ratio
        this.maxDistance = 40 * this.ratio
        this.initCenterX = 15 * this.ratio
        this.initCenterY = 15 * this.ratio
        this.headCenter = {
            x: this.initCenterX,
            y: this.initCenterY
        }
